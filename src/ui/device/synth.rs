...
pub fn sine_synth_card(
    ...
    // TALL, like every other card in the rack. This one used the
    // short default and stood a third shorter than its neighbours,
    // which reads as a mistake rather than as economy.
    card::card_sized(
        ui,
        theme,
        "sine synth",
        crate::ui::tokens::control::DEVICE_TALL_H,
        |ui| {

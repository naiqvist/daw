...
pub static DEVICES: &[DeviceSpec] = &[
    ...
    DeviceSpec {
        kind: DeviceKind::Spectral,
        name: "spectral",
        instrument: true,
        family: Family::Synths,
        prefix: "spectral",
        params: daw::params::spectral::TABLE,
        labels: daw::params::spectral::LABELS,
    },
    DeviceSpec {
    ...
    DeviceSpec {
        ...
        labels: &[
            ParamLabel {
                ...
                unit: "",
                group: "Voice",
                choices: daw::params::drum::MODEL_NAMES,
            },
            ParamLabel {
                name: "Tune",
                unit: " st",
    ...
    DeviceSpec {
        ...
        labels: &[
            ...
            ParamLabel { name: "Speed", unit: " Hz", group: "Vibrato", choices: &[] },
            ParamLabel { name: "Intensity", unit: " ct", group: "Vibrato", choices: &[] },
            ParamLabel { name: "Ornament", unit: "", group: "Gesture", choices: daw::params::acid::ORNAMENT_NAMES },
            ParamLabel { name: "Time", unit: " ms", group: "Gesture", choices: &[] },
            ParamLabel { name: "Speed", unit: " Hz", group: "Gesture", choices: &[] },
            ParamLabel { name: "From", unit: " ct", group: "Gesture", choices: &[] },
            ParamLabel { name: "Other", unit: " ct", group: "Gesture", choices: &[] },
        ],
    },
    DeviceSpec {
